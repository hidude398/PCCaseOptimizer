...
{
	template <typename T>
	T massFlow (T pressure, T density);
	/* Calculates the flow of mass given the volume flowing plus
	 * the density of the gas. */

	float estSaturationVaporPressure (float temperature);
